...
function GameStats({ points, time }) {
  return (
    <section className="flex flex-col gap-2 border border-gray-300 rounded-xl w-[200px] h-[150px] mx-auto bg-gradient-to-b from-zinc-300 to-zinc-500 p-3 shadow-[0px_0px_13px_4px_rgba(52,115,138,1)] absolute top-6 right-4 mt-20">
