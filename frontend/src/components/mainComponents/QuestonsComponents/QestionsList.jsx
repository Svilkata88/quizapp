...
function QestionsList({ elementRef, type }) {
  ...
  return (
    <div
      className="flex flex-col gap-1 bg-gradient-to-b from-zinc-100 to-zinc-400 mt-10 p-5 rounded-lg shadow-[var(--blue-shadow)] scrollable w-[1000px] max-h-150 hidden"
      ref={elementRef}
    >
